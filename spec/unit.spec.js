...
describe('byteskode sms', function () {
  ...
  it('should be able to send SMS in test and development mode', function (
    done) {
  ...
  it('should be able to resend sms(s) in test and development mode',
    function (done) {
      var sms = {
        from: 'TEST',
        to: ['+255 716 000 000', '+255 685 111 111'],
  ...
  it('should be able to obtain unsent sms(s) in test and development mode',
    function (done) {
      var sms = {
        from: 'TEST',
        to: ['+255 716 000 000', '+255 685 111 111'],
